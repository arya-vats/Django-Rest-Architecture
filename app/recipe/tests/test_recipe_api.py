...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email=email, password=password)
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            ...
            price=5,
            time_minutes=3,
            description="This is a sample descriptio of the recipe",
        )
        payload = {
